...
print(f"AdaBoost 随机森林分类准确率: {accuracy_ada_rf:.2f}")
...
print(f"AdaBoost 随机森林交叉验证准确率: {evaluate_model(clf_ada_rf, X, y):.2f}")
...
plot_decision_boundary(clf_ada_rf, X, y, f"AdaBoost 随机森林 决策边界 (准确率: {accuracy_ada_rf:.2f})")
